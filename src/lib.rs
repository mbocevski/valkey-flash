...
valkey_module! {
    ...
    commands: [
        ...
        ["FLASH.BLPOP", flash_blpop_command, "write", 1, -2, 1, "write slow flash"],
        ["FLASH.BRPOP", flash_brpop_command, "write", 1, -2, 1, "write slow flash"],
        ["FLASH.BLMOVE", flash_blmove_command, "write deny-oom", 1, 2, 1, "write slow flash"],
        ...
        ["FLASH.BZPOPMIN", flash_bzpopmin_command, "write", 1, -2, 1, "write slow flash"],
        ["FLASH.BZPOPMAX", flash_bzpopmax_command, "write", 1, -2, 1, "write slow flash"],
