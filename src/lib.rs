...
use crate::config::{
    ...
    FLASH_COMPACTION_INTERVAL_SEC_MIN, FLASH_DEMOTION_BATCH, FLASH_DEMOTION_BATCH_DEFAULT,
    FLASH_DEMOTION_BATCH_MAX, FLASH_DEMOTION_BATCH_MIN, FLASH_DEMOTION_MAX_INFLIGHT,
    FLASH_DEMOTION_MAX_INFLIGHT_DEFAULT, FLASH_DEMOTION_MAX_INFLIGHT_MAX,
    FLASH_DEMOTION_MAX_INFLIGHT_MIN, FLASH_IO_THREADS, FLASH_IO_THREADS_DEFAULT,
...
valkey_module! {
    ...
    configurations: [
        i64: [
            ...
            // demotion knobs — mutable so operators can retune pool
            // contention against client write-through without a restart.
            ["demotion-batch", &FLASH_DEMOTION_BATCH, FLASH_DEMOTION_BATCH_DEFAULT, FLASH_DEMOTION_BATCH_MIN, FLASH_DEMOTION_BATCH_MAX, ConfigurationFlags::DEFAULT, None],
            ["demotion-max-inflight", &FLASH_DEMOTION_MAX_INFLIGHT, FLASH_DEMOTION_MAX_INFLIGHT_DEFAULT, FLASH_DEMOTION_MAX_INFLIGHT_MIN, FLASH_DEMOTION_MAX_INFLIGHT_MAX, ConfigurationFlags::DEFAULT, None],
            // migration knobs
