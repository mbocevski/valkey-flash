...
- Multi-stage Docker image (`docker/Dockerfile`) based on `valkey/valkey:9.0-trixie`; configurable via `FLASH_PATH`, `FLASH_CAPACITY_BYTES`, `FLASH_SYNC`, `FLASH_IO_THREADS`, `FLASH_IO_URING_ENTRIES` environment variables
