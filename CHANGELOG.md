...
- CI coverage gate ≥85% line and function coverage enforced on pull requests (`--fail-under-lines 85 --fail-under-functions 85`); FFI glue, fuzz harnesses, and test-framework build artefacts excluded
